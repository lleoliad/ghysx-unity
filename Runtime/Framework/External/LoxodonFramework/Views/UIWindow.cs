...
namespace Loxodon.Framework.Views
{
    ...
    public abstract class UIWindow : WindowView, IWindow, IManageable
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(UIWindow));

        public static readonly IMessenger Messenger = new Messenger();

        [FoldoutGroup("UIWindow Settings")]
        [SerializeField]
