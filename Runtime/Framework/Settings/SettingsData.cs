...
namespace GhysX.Framework.Settings
{
    ...
    {
        [TabGroup("General")] [DisableInEditorMode] [LabelText("版本号")]
        ...
        [FormerlySerializedAs("AuthServerAddress")] [TabGroup("Server")] [LabelText("授权服务地址")]
        public string authServerAddress = "http://127.0.0.1";

        [TabGroup("Server")] [LabelText("服务地址")]
        public string serverAddress = "http://127.0.0.1";

        [TabGroup("Server")] [LabelText("服务备用地址")]
        public string alternateServerAddress = "http://127.0.0.1";

        [TabGroup("Runtime")] [LabelText("运行模式")] [ValueDropdown(nameof(EPlayModeData))]
        public EPlayMode playMode = EPlayMode.HostPlayMode;

        [TabGroup("Runtime")] [LabelText("目录")]
